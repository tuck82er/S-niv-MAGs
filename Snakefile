...
METAG_SAMPLES = pd.read_table("/home/etucker5/miniconda3/envs/S-niv-MAGs/data/input/ENA_tables/PRJNA766694_metaG_wenv.txt")
...
SCRATCHDIR = "/home/etucker5/miniconda3/envs/S-niv-MAGs/data/scratch"
OUTPUTDIR = "/home/etucker5/miniconda3/envs/S-niv-MAGs/data/output"
METAG_SAMPLELIST = pd.read_table("/home/etucker5/miniconda3/envs/S-niv-MAGs/data/input/SampleList_ForAssembly_metaG.txt", index_col="Assembly_group")
METAG_ASSEMBLYGROUP = list(METAG_SAMPLELIST.index)
ASSEMBLYGROUP = METAG_ASSEMBLYGROUP

#----COMPUTE VAR----#
MEGAHIT_CPU = "80"
MEGAHIT_MIN_CONTIG = "500"
MEGAHIT_MEM = "0.95"
